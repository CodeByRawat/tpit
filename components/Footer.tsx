...
export default function Footer() {
  return (
    <footer style={{ background: '#1B2D5A' }} className="pt-16 pb-8">
            ...
            <div className="flex gap-3">
              {SOCIALS.map(({ label, icon }) => (
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:bg-green-hero hover:text-white transition-all duration-200"
                >
                  {icon}
                </a>
              ))}
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {NAV_LINKS.map(({ label, href }) => (
                <a key={href} href={href} className="text-white/50 text-sm hover:text-white transition-colors duration-200">
                  {label}
                </a>
              ))}
            </div>
